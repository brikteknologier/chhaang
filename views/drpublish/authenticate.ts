...
$(document).ready(function () {
  ...
  $('#objectButton').click(function () {
    ...
    const height = this.APPSETTINGS.height;
    const width = this.APPSETTINGS.width;
    const background = this.APPSETTINGS.background;
    var element = $(
      '<div style="width: ' +
        width +
        'px; height: ' +
    ...
    var videoFrame = $(
      '<iframe width="' +
        ...
        '" height="' +
        height +
        '" src="http://johanna.brik.no/video/embed/e46ae1f3-023a-419b-a963-222c6222813c" frameborder="0"></iframe>'
    );
